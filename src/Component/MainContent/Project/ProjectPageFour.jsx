    ...
    <div>
      ...
      <div className={styles.descriptionBlock}>
        <p className={styles.description}>
          ...
          ФАСАДИ ВІД AGT, КУХОНИИЙ ФАРТУХ ІЗ ГАРТОВАНОГО СКЛА, ФУРНІТУРА ВІД
          ФІРМИ BLUM, LED-ПІДСВІТКА. ШАФИ-КУПЕ В ПРИХОЖУ ІЗ АЛЮМІНІЄВОЇ РОЗСУВНОЇ
          СИСТЕМИ. НА МІЖКІМНАТНУ ПЕРЕГОРОДКУ ВИКОРИСТАНО ГРАФІТОВЕ СКЛО
        </p>
      </div>
    </div>
  );
