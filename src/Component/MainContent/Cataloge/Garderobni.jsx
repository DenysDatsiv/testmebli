...
<p className={styles.description}>
        МЕБЛІ В ГАРДЕРОБНУ КІМНАТУ ДОЗВОЛЯТЬ ВАМ ЗРУЧНО ЗБЕРІГАТИ РЕЧІ ЕФЕКТИВНО
        ВИКОРИСТАВШИ ПРИМІЩЕННЯ РОЗРОБИМО ПРОЕКТ ВРАХУВАННЯМ ВАШИХ ПОБАЖАНЬ.
        ДОСТАВИМО І ВИКОНАЄМ ПРОФЕСІЙНИЙ МОНТАЖ.ТАКОЖ ВИ МОЖЕТЕ ЗАМОВИТИ
